...
interface LangProviderProps {
  ...
  initialLang?: LangCodes; // Receive language value from SSR
  langConfig?: typeof importedLangConfig;
}
...
export const LangProvider: React.FC<LangProviderProps> = ({ 
  ...
  const [lang, setLang] = useState<LangCodes>('kr'); // Temporary initialization

  useEffect(() => {
    setMounted(true);
    
    // Priority order: localStorage > initialLang > browser language > default
